...
namespace TemporadapfihsOntology
{
	[ExcludeFromCodeCoverage]
	public class Thing : GnossOCBase
	{
		public Thing(string pIdentificador) : base(pIdentificador)
		{
		}
		...
		public virtual SecondaryResource ToGnossApiResource(ResourceApi resourceAPI,string identificador)
		{
			...
			GetProperties();
			SecondaryOntology ontology = new SecondaryOntology(resourceAPI.GraphsUrl, resourceAPI.OntologyUrl, "https://schema.org/Thing", "https://schema.org/Thing", prefList, propList,identificador,listSecondaryEntity, null);
		...
		public override List<string> ToOntologyGnossTriples(ResourceApi resourceAPI)
		{
			...
			AgregarTripleALista($"{resourceAPI.GraphsUrl}items/{Identificador}", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", $"<https://schema.org/Thing>", list, " . ");
			AgregarTripleALista($"{resourceAPI.GraphsUrl}items/{Identificador}", "http://www.w3.org/2000/01/rdf-schema#label", $"\"https://schema.org/Thing\"", list, " . ");
		...
		{
			return $"{resourceAPI.GraphsUrl}items/TemporadapfihsOntology_{ResourceID}_{ArticleID}";
		}
