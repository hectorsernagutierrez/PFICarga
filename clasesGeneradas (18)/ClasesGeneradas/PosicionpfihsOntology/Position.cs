...
namespace PosicionpfihsOntology
{
	[ExcludeFromCodeCoverage]
	public class Position : GnossOCBase
	{
		public Position(string pIdentificador) : base(pIdentificador)
		{
		}
		...
		public virtual string RdfType { get { return "https://schema.org/extended/Position"; } }
		public virtual string RdfsLabel { get { return "https://schema.org/extended/Position"; } }
		...
		public virtual SecondaryResource ToGnossApiResource(ResourceApi resourceAPI,string identificador)
		{
			...
			GetProperties();
			SecondaryOntology ontology = new SecondaryOntology(resourceAPI.GraphsUrl, resourceAPI.OntologyUrl, "https://schema.org/extended/Position", "https://schema.org/extended/Position", prefList, propList,identificador,listSecondaryEntity, null);
		...
		public override List<string> ToOntologyGnossTriples(ResourceApi resourceAPI)
		{
			...
			AgregarTripleALista($"{resourceAPI.GraphsUrl}items/{Identificador}", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", $"<https://schema.org/extended/Position>", list, " . ");
			AgregarTripleALista($"{resourceAPI.GraphsUrl}items/{Identificador}", "http://www.w3.org/2000/01/rdf-schema#label", $"\"https://schema.org/extended/Position\"", list, " . ");
		...
		{
			return $"{resourceAPI.GraphsUrl}items/PosicionpfihsOntology_{ResourceID}_{ArticleID}";
		}
